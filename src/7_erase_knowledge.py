...
relations = ['P27', 'P31', 'P108', 'P1001', 'P1303']
...
def main():
    ...
    if os.path.exists(args.tmp_data_path):
        with open(args.tmp_data_path, 'r') as f:
            ...
            for relation in relations:
                eval_bag_list_perrel[relation] = tmp[relation]
    else:
    ...
    def erase(rel):
        ...
        for layer, pos in kn_rel:
            ...
            model.bert.encoder.layer[layer].output.dense.weight[:, pos].data = 0 * model.bert.encoder.layer[layer].output.dense.weight[:, pos].data
        # ============================================== erase knowledge end =============================================================
